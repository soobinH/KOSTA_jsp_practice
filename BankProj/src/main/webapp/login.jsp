	...
	<form action="login" method="post">
		...
		<div class="wrap">
			<div class="row">  
				...
				<div class="input"><input type="text" name="id" value='<%=request.getAttribute("id")%>'/></div>
			</div>
			<div class="row">  
				<div class="title">비밀번호</div>
				<div class="input"><input type="text" name="password" value='<%=request.getAttribute("password")%>'/></div>
			</div>
			<div class="row">  
