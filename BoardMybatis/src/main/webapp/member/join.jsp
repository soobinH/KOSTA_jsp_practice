...
<script type="text/javascript">
	$(function() {
		...
		$("#doubleId").click(function(e) { // 중괄호 위치 수정
	    e.preventDefault();
	    
	    if ($("#id").val().length == 0) { // if문 추가 및 괄호 수정
	        alert("아이디를 입력하세요.");
	        return;
	    }
		
		$.ajax({
			url:'${contextPath}/member/doubleId',
			type:'post',
			dataType:'text',
			data:{id:$('#id').val()},
...
<body>
	<form action="join" method="post" enctype="multipart/form-data">
		...
		<div class="wrap">
			<div class="row">  
				<div class="input">
					<img src='${contextPath}/img/person.jpg' onclick="document.querySelector('#profile').click();"
						id="preview" width="260px"/>
			...
			<div class="row">  
				...
				<div class="input">&nbsp;<button type="button" id="doubleId">중복</button></div>
			</div>
			<div class="row">  
